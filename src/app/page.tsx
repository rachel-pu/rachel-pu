  ...
  return (
      <div className="min-h-screen flex flex-col">
          ...
          <div className="h-screen flex flex-col p-6">
              ...
              <div className=" items-center flex mt-[12%] mb-20 mr-auto ml-auto flex-row max-w-[60%] justify-between" style={{ userSelect: "none" }}>
              ...
              <motion.div className="flex flex-row  mb-auto ml-auto mr-auto w-[40%] justify-around p-2"
                  ...
                  <motion.button className="text-[#2B2B2B] text-2xl font-product-sans pr-4 pt-1 pb-1 pl-4 rounded-3xl flex flex-row items-center justify-center"
                                 whileHover={{ scale: 1.05, transition: { duration: 0.15}, backgroundColor: '#7ea663', color: '#ECDED6'}}
                                 whileTap={{ scale: 0.95 }}
                  ...
                  {/* linkedin */}
                  <motion.button className="text-[#2B2B2B] text-2xl font-product-sans pr-4 pt-1 pb-1 pl-4 rounded-3xl flex flex-row items-center justify-center"
                                 whileHover={{ scale: 1.05, transition: { duration: 0.15}, backgroundColor: 'rgba(88,123,178,0.7)', color: '#ECDED6'}}
                                 whileTap={{ scale: 0.95 }}
                  ...
                  {/* github */}
                  <motion.button className="text-[#2B2B2B] text-2xl font-product-sans pr-4 pt-1 pb-1 pl-4 rounded-3xl flex flex-row items-center justify-center"
                                 whileHover={{ scale: 1.05, transition: { duration: 0.15}, backgroundColor: 'rgba(141,101,187,0.7)', color: '#f6ede5'}}
                                 whileTap={{ scale: 0.95 }}
