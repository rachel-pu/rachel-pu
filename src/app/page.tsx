  ...
  return (
      <div className="min-h-screen flex flex-col">
          <div className="flex flex-col p-6">
              ...
              <div className="flex flex-col mt-[12%] mr-auto ml-auto max-w-[60%]" style={{ userSelect: "none" }}>
                  <motion.h1 className="text-3xl font-janitor text-[#2B2B2B] ml-2"
              ...
              <AnimatePresence mode="wait">
                {!showProjects ? (
                  ...
                  >
                    <div className="items-center flex mb-20 mr-auto ml-auto flex-row max-w-[60%] justify-between" style={{ userSelect: "none" }}>
                      <div className="flex flex-col max-w-[80%]">
                        <motion.p className="text-2xl font-product-sans text-[#2B2B2B] mt-4 ml-2"
                                  initial={{ transform: "translateY(10px)", opacity: 0 }}
                                  animate={{ transform: "translateY(0px)", opacity: 1}}
                                  transition={{delay: 1}}
                        >I&apos;m a software engineer at Datadog.</motion.p>
                        <motion.div
                                  initial={{ opacity: 0 }}
                                  animate={{ opacity: 1 }}
                        ...
                        <motion.div className="flex flex-row gap-6 ml-2 mt-6"
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
